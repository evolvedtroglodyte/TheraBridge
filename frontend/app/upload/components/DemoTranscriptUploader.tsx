...
export default function DemoTranscriptUploader({ onUploadSuccess }: DemoTranscriptUploaderProps) {
  ...
  return (
    <div className="w-full max-w-[500px] text-center">
      ...
      <h2 style={{ fontFamily: fontSerif }} className="text-[18px] font-semibold text-gray-800 dark:text-gray-200 mb-2">
        Upload Demo Session
      </h2>
      <p style={{ fontFamily: fontSerif }} className="text-[13px] text-gray-500 dark:text-gray-400 mb-6">
      ...
      >
        ...
        {/* Dropdown Label */}
        <label style={{ fontFamily: fontSerif }} className="block text-[12px] font-semibold text-gray-600 dark:text-gray-400 text-left mb-2">
          Select Session
        </label>
        ...
        {/* Session Description */}
        {selectedInfo && (
          <p style={{ fontFamily: fontSerif }} className="text-[11px] text-gray-500 dark:text-gray-400 text-left mt-2 mb-5">
        ...
        <div className="flex items-start gap-2.5 bg-[#5AB9B4]/[0.08] dark:bg-[#a78bfa]/[0.1] rounded-lg px-3.5 py-3 mt-4 text-left">
          ...
          <p style={{ fontFamily: fontSerif }} className="text-[11px] text-[#5AB9B4] dark:text-[#a78bfa] leading-relaxed">
